...
export class Zii extends Character{ // <- change Character_Name to your character's name! No spaces or special characters
    constructor(){
        ...
        this.character_choices = new Zii_Choices() // <- replace Char_Name with your character's name, no spaces or special characters.
    }
    ...
    load_images(){
        this.images["Zii"] = loadImage('assets/images/zii.png'); // <- upload your own image and use it here!
